...
public class DistributedLockServiceImpl implements DistributedLockService {
  ...
  public <T> T executeWithLock(String lockKey, Supplier<T> supplier) {
    return this.executeWithLock(lockKey, DEFAULT_WAIT_TIME, DEFAULT_LEASE_TIME, TimeUnit.SECONDS, supplier);
  }
  ...
  public <T> T executeWithLock(String lockKey, long waitTime, long leaseTime, TimeUnit timeUnit, Supplier<T> supplier) {
    String fullLockKey = cacheKeyBuilder.buildCacheFullLockKey(lockKey);
