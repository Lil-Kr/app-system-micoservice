...
import { RoleAdminTableType, TableRowSelection, TableTransferProps } from '@/types/apis/sys/role/roleType'
  ...
  return (
    <Transfer {...restProps} style={{ width: '100%' }} dataSource={dataSource}>
      {({
        ...
        const rowSelection: TableRowSelection<RoleAdminTableType> = {
