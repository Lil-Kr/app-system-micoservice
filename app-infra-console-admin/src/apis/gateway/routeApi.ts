...
const routeApi: RouteConfigApi = {
  ...
  update(req: RouteConfigEditReq) {
    return baseAxiosRequest.post<Result<string>>(PREFIX_URL_ROUTE_CONFIG + '/update', req)
  },
  delete(req: RouteConfigDelReq) {
    return baseAxiosRequest.delete<Result<string>>(PREFIX_URL_ROUTE_CONFIG + '/delete', req)
  },
  configLogList(req: RouteConfigGetReq) {
    return baseAxiosRequest.get<Result<RouteChangeLog[]>>(PREFIX_URL_ROUTE_CONFIG + '/configLogList', {
      params: req
    })
  }
}
