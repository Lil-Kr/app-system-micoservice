 ...
 * sys-admin
 */
export const PREFIX_URL_SYS_USER = '/sys/admin'
 ...
 * route-config
 */
export const PREFIX_URL_ROUTE_CONFIG = '/gateway/config'
/**
 * route-config-change-log
 */
export const PREFIX_URL_ROUTE_CONFIG_LOG = '/gateway/log'
